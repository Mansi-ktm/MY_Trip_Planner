...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center px-8 py-4 shadow-md bg-white">
      <div>
        <img className="w-24 h-auto" src="C:\Users\Asus\OneDrive\AI-trip\ai-trip-planner\mylogo.jpg" alt="Logo" />
      </div>
      {user ? (
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <div className="flex flex-col items-center">
                <img src="C:\Users\Asus\OneDrive\AI-trip\ai-trip-planner\mylogo.jpg" alt="Logo" className="w-20 mb-4" />
